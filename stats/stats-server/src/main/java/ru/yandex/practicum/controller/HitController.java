...
public class HitController {
    ...
    @GetMapping("/stats")
    public List<ViewStats> getStats(@RequestParam @DateTimeFormat(pattern = Constants.DTF) LocalDateTime start,
                                    @RequestParam @DateTimeFormat(pattern = Constants.DTF) LocalDateTime end,
